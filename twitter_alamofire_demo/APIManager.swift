...
class APIManager: SessionManager {
  ...
  private init() {
    ...
    if let dict = keys {
      let myKey = dict["myConsumerKey_API_KEY"] as! String
      let mySecret = dict["myConsumerSecret_API_SECRET"] as! String
      APIManager.consumerKey = myKey
      APIManager.consumerSecret = mySecret
    }
